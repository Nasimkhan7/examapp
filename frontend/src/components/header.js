      ...
      <div className="container">
        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
              <NavLink to="/aboutus" activeClassName=" text-secondary" className="nav-link text-white">
                <svg className="bi d-block mx-auto mb-1" width="24" height="24"><use xlinkHref="#speedometer2"/></svg>
               About Us
              </NavLink>
            </li>
            <li>
              <NavLink to="/Course" activeClassName=" text-secondary" className="nav-link text-white" >
                <svg className="bi d-block mx-auto mb-1" width="24" height="24"><use xlinkHref="#table"/></svg>
                Course
              </NavLink>
            </li>
            <li>
              <NavLink to="/Branch" activeClassName=" text-secondary" className="nav-link text-white">
                <svg className="bi d-block mx-auto mb-1" width="24" height="24"><use xlinkHref="#grid"/></svg>
                Branch
              </NavLink>
            </li>
            <li>
              <NavLink to="#"activeClassName=" text-secondary" className="nav-link text-white">
