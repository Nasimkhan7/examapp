  ...
  return (
    ...
    <div class="container-fluid ">
        <div class="text-center my-2">
          <h1 data-aos="fade-down-right" data-aos-offset="300">FIIT <span class="text-primary">INFORMATION</span> </h1>
  ...
  <div className="row g-0">
    ...
    <div class="col-md-6">
      <div className="card-body shadow ">
        <h5 className="card-title text-center bg-warning">Card title 1</h5>
...
<div className="card mb-3 py-3 py-3 " style={{maxWidth: '540px'}}>
  <div className="row g-0 ">
    ...
    <div class="col-md-6">
      <div className="card-body shadow">
        <h5 className="card-title text-center bg-warning">Card title 2</h5>
        <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p className="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
      </div>
    </div>
...
<div className="card mb-3 py-3 " style={{maxWidth: '540px'}}>
  <div className="row g-0">
    ...
    <div class="col-md-6">
      <div className="card-body shadow">
        <h5 className="card-title text-center bg-warning">Card title 3</h5>
        <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p className="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
      </div>
    </div>
...
<div className="card mb-3 py-3 mx-auto" style={{maxWidth: '540px'}}>
  <div className="row g-0 shadow">
    ...
    <div class="col-md-6">
      <div className="card-body ">
        <h5 className="card-title text-center bg-warning ">Card title 4</h5>
  ...
  <div className="row text-center">
    ...
    <div className="col-lg-4 mb-5 mb-lg-0">
      <div className="bg-white p-5 rounded-lg shadow">
            <h1 className="h6 text-uppercase front-weight-bold mb-4">Basic</h1>
            <h2 className="h1 font-weight-bold">$199 <span className="text-small front-weight-normal ml-2">/Month</span></h2>
            <div className="custom-serperator my-4 mx-auto bg-primary"></div>

            <ul className="list-unstyled my-5 text-small text-left">
                  <li className="mb-3">
                      <i className="fa fa-check mr-2 text-primary"></i>React components for faster 
                   </li>

                   <li className="mb-4">
                      <i className="fa fa-check mr-3 text-primary"></i>React components for faster 
                   </li>
                   ...
                   <li className="mb-3 text-mute">
                      <i className="fa fa-times mr-2 "></i><del>React components for faster</del> 
                   </li>
    ...
    <div className="col-lg-4 mb-5 mb-lg-0">
      <div className="bg-white p-5 rounded-lg shadow">
            <h1 className="h6 text-uppercase front-weight-bold mb-4">Python Language</h1>
            <h2 className="h1 font-weight-bold">$899 <span className="text-small front-weight-normal ml-2">/Month</span></h2>
            <div className="custom-serperator my-4 mx-auto bg-primary"></div>
     ...
     <footer className="bg-light text-dark pt-5 pb-4 mt-3">
        <div className="container text-center text-md-left">
            <div className="row text-center text-md-left">
                        ...
                        <h5 className="text-uppercase mb-4 font-weight-bold text-info">Let Us Helf</h5>
                          <hr className="mb-4"></hr>
                          <p>
                        ...
                        <h5 className="text-uppercase mb-4 font-weight-bold text-info">Contact Us</h5>
                          <hr className="mb-4"></hr>
                          <p>
